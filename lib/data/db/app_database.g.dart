...
class $TransactionsTable extends Transactions
  ...
  late final GeneratedColumn<String> paymentMethod = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    defaultValue: const Constant('微信'),
  );
...
class CategoryEntry extends DataClass implements Insertable<CategoryEntry> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, type, name, color, sortOrder, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$NotesTable, NoteEntry>(table),
                  BaseReferences<_$AppDatabase, $NotesTable, NoteEntry>(
                    db,
                    table,
                    e,
                  ),
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$TasksTable, TaskEntry>(table),
                  BaseReferences<_$AppDatabase, $TasksTable, TaskEntry>(
                    db,
                    table,
                    e,
                  ),
